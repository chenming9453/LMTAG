...
#data_path = "/Users/mingchen/Documents/2020_spring/project_IPF_integrate_analysis/main/code/example_data"
#trait_1 = "IPF"
#trait_2 = "AD"
#chr = 1
#output = "/Users/mingchen/Desktop"

print(trait_1)
print(chr)
print(data_path)

snplist = pd.read_csv("/Users/mingchen/Documents/2020_spring/project_IPF_integrate_analysis/main/code/snplist.txt", delimiter = '\t')
arr = os.listdir(data_path)
if '.DS_Store' in arr:
    arr.remove('.DS_Store')
traits = np.unique(list(flatten([t.split("_") for t in arr ])))
T = len(traits)
